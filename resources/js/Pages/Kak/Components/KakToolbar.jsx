        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            {auth.user.role_id === 3 && (
                <Link
                    ...
                    className="inline-flex items-center justify-center py-2.5 px-6 rounded-xl bg-cyan-50 text-cyan-600 hover:bg-cyan-600 hover:text-white transition-all duration-300 ease-in-out shadow-sm hover:shadow-md active:scale-95 border border-cyan-100 hover:border-cyan-600 font-semibold"
                >
