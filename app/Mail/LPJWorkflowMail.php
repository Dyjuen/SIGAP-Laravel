...
class LPJWorkflowMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: $this->mailData['subject'] ?? 'Pemberitahuan LPJ - SIGAP PNJ',
        );
    }
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'status_color' => $this->mailData['status_color'] ?? '#dc3545',
            ],
        );
    }
