...
class StoreKegiatanRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'penanggung_jawab_manual.max' => 'Penanggung Jawab maksimal :max karakter.',
            'pelaksana_manual.max' => 'Pelaksana maksimal :max karakter.',
            'nama_kegiatan.max' => 'Nama Kegiatan maksimal :max karakter.',
            'lokasi.max' => 'Lokasi maksimal :max karakter.',
            'surat_pengantar.max' => 'Surat Pengantar maksimal :max KB.',
