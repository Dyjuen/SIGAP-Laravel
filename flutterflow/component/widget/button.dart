            ...
            Opacity(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    if (valueOrDefault<bool>(widget!.iconPresent, false))
                      widget!.icon!,
                    Text(
                      valueOrDefault<String>(widget!.content, 'Masuk'),
                      maxLines: 1,
                    ...
                    if (valueOrDefault<bool>(widget!.iconEndPresent, false))
                      widget!.iconEnd!,
