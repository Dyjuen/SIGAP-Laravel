...
import 'dart:ui';
import '../../widget/k_a_k_submission_form_widget.dart' show KAKSubmissionFormWidget;
...
class KAKSubmissionFormModel extends FlutterFlowModel<KAKSubmissionFormWidget> {
  ...
  void initState(BuildContext context) {
    formStepIndicatorModel1 =
        createModel(context, () => FormStepIndicatorModel());
    formStepIndicatorModel2 =
        createModel(context, () => FormStepIndicatorModel());
    formStepIndicatorModel3 =
        createModel(context, () => FormStepIndicatorModel());
